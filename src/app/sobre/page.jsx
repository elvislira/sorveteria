...
import Amigos from '/public/sobre-image.jpg';
...
export default function Sobre() {
    return (
        <div className={estilos.sobre_container}>
            <section className={estilos.sobre_container_capa}>
                <h1>A Gelateria</h1>
            </section>

            <section className={estilos.sobre_container_textos}>
                <h2>Sobre Nós</h2>
            ...
            <section className={estilos.sobre_container_img}>
                <div>
                    <Image src={Amigos} alt='Imagem de amigos' />
                </div>
